        ...
        <div className="flex-1">
          <dt className="truncate text-xs sm:text-sm font-medium text-foreground">
            <Link href={`/blog/${article.slug}`} className="focus:outline-none">
              ...
              <h2 className="text-lg sm:text-xl font-semibold font-mono text-pretty">
                {article.title}
              </h2>
            </Link>
          </dt>
...
export const metadata: Metadata = generateMetadata({
  ...
  description:
    "Explore my latest thoughts on web development, programming, technology, and software engineering. Discover tutorials, insights, and deep dives into modern web development practices.",
  path: "/blog",
  type: "website",
  tags: [
    "Blog",
...
export default async function ArticlesIndex() {
  ...
  const structuredData = generateStructuredData("WebSite", {
    name: "Blog",
    description:
      "Technical blog covering web development, programming, and software engineering topics.",
